...
double Px=0.075,Ix=0.001,Dx=0.0;// 0.0025,0.0001,0.000025
...
double xOrgAngle=134;
double yOrgAngle=160;
...
int imgCount=0;
#define WNO  1000 // drawing speed. motor is 4000 max, coil is 400 max.
#define WNO2 250  //
