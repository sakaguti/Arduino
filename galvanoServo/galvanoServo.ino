...
double Px=0.05,Ix=0.001,Dx=0.00;// 0.0025,0.0001,0.000025
...
double xSetAngle=0.0, xSetAngleDt=1.0, xSetAngleOld=0.0;
...
boolean dSW=true; // whether image draw or not.

#define MAXDRAW 1000 // How many draw image repeatable
int patternNo=0; // draw image pattern.
int drawCount=0; // How many draw image
int imgCount=0;
// if WNO < 5 then undef SERVO_KICK
//#define WNO 5000 // square
#define WNO 4000
//#define SERVO_KICK
  ...
  switch(pn){
    ...
    // draw circle
      ...
      ic=(int)(imgCount/WNO);
        ...
        ySetAxis = 0.6*0.15*C*R*sin(M_PI*(double)imgCount/(double)WNO)+CY;
        xSetAngle=XYtoDeg(xSetAxis);
        ySetAngle=XYtoDeg(ySetAxis);
        imgCount++;
        break;
