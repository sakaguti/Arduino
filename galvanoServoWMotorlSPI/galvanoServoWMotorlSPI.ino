...
double Px=0.02500,Ix=0.0001,Dx=0.0000025;// 0.0025,0.0001,0.000025
...
double Y_OUTPUT_MIN= -3.0;
double Y_OUTPUT_MAX=  3.0;

double xAngle,xSpeed=0.0;
double yAngle,ySpeed=0.0;

double xOrgAngle=100.0;
double yOrgAngle=170;
...
double GainAdjust(double v, double vOld)
{
    double x;
    x=abs(v-vOld);
    return 1.0-0.75/(1.0+exp(-2.0*(x-5.0)))+0.1;
}
#endif
